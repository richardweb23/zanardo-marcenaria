...
export const metadata = {
  title: "Contato | Zanardo Marcenaria",
  description:
    "Entre em contato com a Zanardo Marcenaria, especializada em móveis planejados sob medida e marcenaria de alto padrão no Rio de Janeiro. WhatsApp e Instagram disponíveis.",
  openGraph: {
    title: "Contato | Zanardo Marcenaria",
    description:
      "Entre em contato com a Zanardo Marcenaria, especializada em móveis planejados sob medida e marcenaria de alto padrão no Rio de Janeiro. WhatsApp e Instagram disponíveis.",
    url: "https://www.zanardomarcenaria.com.br/contato",
    type: "website",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://www.zanardomarcenaria.com.br/contato",
  },
}
