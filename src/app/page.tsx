  ...
  return (
    <>
      <main className="min-h-screen bg-gray-50">
        ...
        >
          <div className="w-full flex pt-0 bg-cover bg-center bg-no-repeat bg-blend-multiply animate-fadeInUp" style={{ backgroundImage: "url('/bg-1.jpg')" }}>
            <div className="w-full lg:w-[50%] pt-12 pb-12 px-12 bg-black/60 lg:bg-black/50 animate-fadeIn">
              ...
              <section className="mt-6 text-lg text-white font-relaway">
        ...
        <section id="sobre" className="w-full py-20 px-20 animate-fadeIn">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-relaway mb-2">Sobre Nós</h2>
        ...
        {/* Resumo Sobre e1cc9d */}
        <section id="sobre" className="w-full bg-white py-20 px-20 animate-fadeIn">
          <div className="w-full mx-auto text-center">
            <h3 className="text-3xl font-relaway mb-2">Portfólio</h3>
        ...
        <section id="sobre" className="w-full bg-gray-50 pb-20 pt-6 animate-fadeIn">
          <div className="w-full mx-auto text-center">
            <Contato />
          </div>
        </section>
